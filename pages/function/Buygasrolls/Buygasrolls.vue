			...
			<view class="card">
				<view class="card-content">
					<view class="card-content-inner">
						...
						<p style="border-bottom: 1px solid #DDDDDD;margin-top:1.7rem;display: flex;flex-direction: row;" class="je">
							<span style="font-size: 0.8rem;font-weight: normal;display: flex;align-items: center;padding-right: 10upx;">￥</span>
							<input type="number" v-model="BuyMoney" style="font-size: .9rem;" placeholder="请输入加油金额" @focus="Changestate"/>
