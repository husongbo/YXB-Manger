<template name="simpleAlert">
	<view :class="[show ? 'animate-show simple-alert' : 'animate-hide simple-alert']">
		<view class="icon simple-icon"></view>
...
.simple-alert{display:flex; width:100%; padding:20rpx 0%; flex-wrap:nowrap; background:#FFF; position:fixed; z-index:99999; left:0; top:-60px;}
...
.simple-alert .icon{width:35rpx; line-height:35rpx; justify-content:center; flex-shrink:0; margin:0 12px;}
