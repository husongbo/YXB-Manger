		...
		<view class="modal-box " :class="isVisibility?'show':''" @touchmove.stop.prevent="moveHandleStop">
		  <view class="dialog">
		    ...
		    <view class="simple-bar has-bordert">
				<view class='action has-mg-0 flex-sub text-green'  @tap='handleClose'>{{cancelButtonText}}</view>
				<view class='action has-mg-0 flex-sub has-borderl'  @tap='handleConfirm'>{{confirmButtonText}}</view>
		    </view>
		  </view>
		</view>
	</view>
